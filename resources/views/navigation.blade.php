<router-link tag="h3" :to="{name: 'nova-custom-permission'}" class="cursor-pointer flex items-center font-normal dim text-white mb-6 text-base no-underline">
